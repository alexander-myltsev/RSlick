...
setwd(lib.java.path)
rslick.jars <- c("RSlick-Scala-0.2.0.jar", "mysql-connector-java-5.1.12.jar", "h2-1.4.182.jar")

download.sites <- c("file:///tmp/", "http://github.com/alexander-myltsev/RSlick/releases/download/v0.1.0/")
